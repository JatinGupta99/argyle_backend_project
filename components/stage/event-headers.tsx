  ...
  return (
    <div className="flex flex-col bg-slate-50/50 dark:bg-slate-950/50">
      ...
      <div className="w-full px-8 md:px-12 mt-6 mb-6">
        <div className={`relative aspect-[21/9] md:aspect-[3.5/1] w-full ${maxWidthClass} mx-auto rounded-2xl overflow-hidden shadow-xl border border-white/20 ring-1 ring-black/5 group`}>
          <Image
            src={imageSrc}
            alt={title}
            fill
      ...
      <div className="w-full px-8 md:px-12 pb-4">
        <div className={`flex items-center justify-between border-b border-slate-200 pb-4 ${maxWidthClass} mx-auto`}>
